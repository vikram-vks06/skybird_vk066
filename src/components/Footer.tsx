...
export default function Footer() {
  return (
    <footer className="border-t border-navy/8 bg-bg py-16 px-4 md:px-6" style={{ borderColor: 'rgba(15,31,61,0.08)' }}>
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        {/* Logo + Brand */}
        <Link href="/" className="flex items-center gap-2.5" aria-label="Sky Birds home">
          <AppLogo size={32} />
          <span className="font-sans text-base tracking-tight text-navy" style={{ fontWeight: 800 }}>
