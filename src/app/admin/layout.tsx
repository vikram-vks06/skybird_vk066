  ...
  return (
    <div className="min-h-screen bg-bg flex">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-6 py-6 border-b border-white/8">
            <Link href="/admin" className="flex items-center">
              <AppLogo width={152} className="h-auto" />
            </Link>
            <p className="text-white/25 text-[10px] uppercase tracking-widest mt-1 font-semibold">
              Admin Panel
            </p>
          </div>
          ...
          <div className="px-4 py-4 border-t border-white/8">
            <div className="flex items-center gap-3 mb-3">
              <div
                ...
                style={{ backgroundColor: 'rgba(232,160,32,0.3)' }}
              >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Bar */}
        <header
          className="bg-white border-b sticky top-0 z-30 px-6 py-4 flex items-center justify-between"
        ...
        >
          ...
          <Link
            href="/"
            target="_blank"
            className="text-sm text-navy/40 hover:text-navy transition-colors font-semibold"
          >
            View Site ↗
          </Link>
        </header>
